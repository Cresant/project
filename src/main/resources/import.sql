...
-- insert user data
INSERT INTO "user" (login, password, active,  email) VALUES ('admin', '123456', true,  'admin@gmail.com');
INSERT INTO "user" (login, password, active, email) VALUES ('user', '123456', true,  'user@gmail.com');
INSERT INTO "user" (login, password, active, email) VALUES ('user2', '123456', false, 'user2@gmail.com');
...
INSERT INTO "good" (title, small_image_link, description, quantity, price, category_id, active) VALUES ('Tablet LA AS NOOO70000', '/resources/img/tablet_la_as.jpg', '"Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.', 1, 23500, 2, false);
